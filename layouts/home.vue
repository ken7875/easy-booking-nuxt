<template>
  <div class="w-full overflow-x-hidde">
    <nav class="nav fixed top-0 left-0 w-full bg-black flex justify-between items-center opacity-0 z-[110] h-[6.5rem] px-5">
    ...
    <div class="navbar w-full h-screen bg-black mb-[130vh] z-40 overflow-x-hidden">
      <div class="h-full grid grid-cols-8">
        ...
        <div class="col-span-5 h-full relative">
          <div class="content absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] text-[2rem] z-20 w-[70%]">
            <p class="text-white absolute block">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            <p class="text-white absolute opacity-0 block">Quas, dolorum ipsum alias cumque nam fugiat inventore aspernatur.</p>
            <p class="text-white absolute opacity-0 block">Lorem ipsum dolor sit amet consectetur adipisicing elit.dfsonfdlkng dskfjkldfnvo</p>
          </div>
        </div>
      </div>
