<template>
  <div
    class="fixed top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.3)] z-messageShadow flex justify-center"
    @click.stop.self.prevent="handleAction('cancel')"
  >
    <Card
      :class="[
        'relative z-message lg:w-[35%] w-[80%] h-[35%] px-[2rem] py-[1rem] animate-scale lg:mt-[5%] mt-[30%]',
        type
      ]"
    >
      <template #header>
