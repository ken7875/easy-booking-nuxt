    ...
    <main class="mb-2 grid grid-cols-5 w-full">
      <div class="lg:mr-[20px] lg:mb-0 lg:col-[1_/_3] col-[1_/_6] mr-0 mb-[30px]">
        <div class="border-2 border-darkLight p-4 mb-5 pb-2">
          ...
          <p class="text-center my-2 text-[1.2rem] border-b-2 border-darkLight pb-[12px]">2晚</p>
          <div>
      ...
      <div class="border border-darkLight p-4 lg:col-[3_/_6]">
        <h3 class="text-[1.5rem] text-center mb-[20px]">房客資訊</h3>
...
import { getReserveDataApi } from '~~/api/booking';

const { useBooking } = useStore();

const bookingStore = useBooking();
const { data: reserveHotelInfo } = useAsyncData('reserveInfo', () => getReserveDataApi());
const { bookingForm } = storeToRefs(bookingStore);
